...
const SEO_BY_LOCALE: Record<string, { title: string; description: string }> = {
  en: {
    ...
    description:
      "A small, deliberate practice in Düsseldorf and Berlin. Six people, four principles, twelve case studies.",
  },
  de: {
    title: "Studio — Transad",
    description:
      "Ein kleines, bewusstes Studio in Düsseldorf und Berlin. Sechs Personen, vier Prinzipien, zwölf Fallstudien.",
  },
};
